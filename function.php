...
<body style='background-color: #fcc329;' align='center'>
            <h3 style='color: #a01064;'>$community_caption
    ...
    print '<div id="down-btn" style="border: 2px solid #fcc329; background-color: transparent; border-radius: 10px; height: 80px; width: 33%; margin: auto;">
                        <a href="#posts" class="btn page-scroll">
                            <p style="color: #a01064; text-align: center; background-color: #fcc329;">See Posts<br>
                            <span class="glyphicon glyphicon-chevron-down" aria-hidden="true" style="margin-top: 10px; color: #a01064;"></span></p>
                        </a>
                        </div>';
        ...
        while ($row = mysql_fetch_array($r)){
            if (!empty($row['post'])) {
                  ...
                  print "<p style='color: #00ff25; float: right; margin-right: 15px; font-size: 12px;'>" . date_format($text_date, "M d, Y") . "</p>";
                    ...
                    print "<div style='background-color: #f9257a;' class='well' id='wellbox'><h4 style='color: #28eafc; font-family: verdana;'>" . $row['post'] . "</h4>";
...
border-bottom-left-radius: 10px; background-color: #9a2afc;">
    <div>
        ...
        <a href="connect.php"><span style="color: #a01064;" class="glyphicon glyphicon-chevron-left" aria-hidden="true" id="backButton"></span></a>
...
function create_form($com){
    ...
    print "<form action = '$path' method='post'><textarea name = 'post' style='color: #0eccb5; border: 2px solid #2d2d2d; background-color: #f7e8c0; outline: none; text-align: center'></textarea><br><br>
        <input style='background-color: #9a2afc; color: #00ff25;' type='submit' value = 'Post' id = 'red_input' name='red' placeholder='post to this community'>
        </form></div>";
    print "<style>
        #red_input{
                height: 50px;
...
function create_user_form(){
    $path = 'you.php';
    print "<form action = '$path' method='post'><textarea name = 'post' style='color: #0eccb5; border: 2px solid black; background-color: #f7e8c0; outline: none; text-align: center; font-size: 15px; width: 200px;' placeholder='What do you want to say?'></textarea><br><br>

        <input style='background-color: #9a2afc; color: #00ff25;' type='submit' value = 'Post' id = 'red_input' name='red'></input>
