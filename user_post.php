...
<body style="margin: 10px; background-color: #fcc329;">
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide" style="background-color: #fcc329;">
        ...
        <form enctype="multipart/form-data" action="user_post.php" method="post">
        	...
        	<label style="background-color: #28eafc;" for="file"><h2 style='color: #a01064; text-align: center;'><b>Upload Picture</b></h2></label>
        		<br>
        	<b><input style="background-color: #9a2afc; color: #00ff25;" type="submit" value="Post" id='red_input'/></input></b>
