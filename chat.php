...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <body align="center" style="margin: 20px; background-color: #fcc329;">
        ...
        <h2 style='font-family: sans-serif; display: inline; color: #a01064; text-align: center;'>Messages

        <a href = 'new_chat.php' style='font-size: 40px; color: #a01064; text-decoration: none; display: inline; float: right; margin-top: -5px;'> + </a></p>
