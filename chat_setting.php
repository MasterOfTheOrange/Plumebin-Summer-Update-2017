...
<h1 style="color: #a01064;">Chat Settings</h1>
<br>

    <form action="chat_setting.php" method="post">

        <input type="submit" name="clear" value="Empty Chat" class="btn btn-danger" style="color: #9a2afc; background-color: lightblue; border: none; height: 70px; width: 120px;">
		<br>
		<br>
        <input type="submit" name="delete" value="Delete Chat" class="btn btn-danger" style="color: #37c912; height: 70px; width: 120px;">
...
border-bottom-left-radius: 10px; background-color: #9a2afc;">
    <div>
        ...
        <a href='chat_r.php'><span style="color: #a01064;" class="glyphicon glyphicon-chevron-left" aria-hidden="true" id='backButton'></span></a>
