...
border-bottom-left-radius: 10px; background-color: #9a2afc;">
    <div>
        ...
        <a href='other_user.php?username=<?php  print $_SESSION['other_user'];  ?>'><span style="color: #a01064;" class="glyphicon glyphicon-chevron-left" aria-hidden="true" id='backButton'></span></a>
